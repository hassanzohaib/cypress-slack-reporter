...
CypressNpmApi.run({
    ...
    .then(function (delFiles) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, del(["cypress/reports/mocha/mochawesome_*.json"])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    var vcsRoot = program.vcsProvider;
